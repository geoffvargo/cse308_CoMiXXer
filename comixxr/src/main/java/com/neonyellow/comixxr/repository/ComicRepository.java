...
public interface ComicRepository extends MongoRepository<Comic, ObjectId > {
    ...
    List<Comic> findAllByUserIdAndAgeBeforeAndPrivacyOrderByAgeDesc(ObjectId id, LocalDateTime time, Privacy privacy);
    List<Comic> findAllByTitleContainingAllIgnoreCaseAndPrivacy(String title, Privacy privacy);
}
